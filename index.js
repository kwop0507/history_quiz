...
const modalMessageList = [
    { "number": 1, "message": "청동기 시대" },
    { "number": 2, "message": "반굴과 관창" },
    { "number": 3, "message": "팔공산" },
    { "number": 4, "message": "외규장각 의궤" },
    { "number": 5, "message": "어재연 장군기" },
    { "number": 6, "message": "부산" },
    { "number": 7, "message": "명량대첩" },
    { "number": 8, "message": "강화도 조약" },
